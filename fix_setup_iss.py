"""
Updates setup.iss to use {#SourceDir} and {#OutputDir} defines
for all file source and output paths — making it portable.
"""

SETUP_ISS = r"d:\pico\setup.iss"
...
print("Done - setup.iss rewritten with {#SourceDir} and {#OutputDir} defines.")
